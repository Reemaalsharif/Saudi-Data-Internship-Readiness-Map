...
The new postings added were:

- Data Analyst — Lucid Motors Middle East
- ICQA Researcher, MEATR ICQA — Amazon
- Data Analyst Excel - Remote — YO IT Consulting
- Data Scientist Expert (AI Community) — TELUS Digital AI Data Solutions
- Robotics Data Collector (Saudi Arabia) — CNTXT AI
- AI Trainer - Freelance Data Annotator — Toloka Annotators
- Data Scientist — Auxo Talent
- Performance Analyst — The Chefz
- AI / ML Senior Analyst - Jeddah — MBRF
- Data Scientist - Remote — YO IT Consulting

During the review, some postings were skipped because they were either likely duplicates, too broad, too senior or managerial, or not strongly related to the project focus.

Examples of skipped postings:
- Senna Data Analyst, because it was very similar to the Lucid Motors Data Analyst posting.
- Firstsource Data Collector, because it was closer to gig image collection than a data analytics role.
- Understanding Recruitment Quantitative Researcher, because it was focused on the UK and Europe rather than Saudi Arabia.
- Walaa Analytics and Pricing Manager, because it was a manager-level role with high experience requirements.

## Day 15 Data Quality Notes

After adding the new postings:

- The dataset contains 35 job postings.
- The `job_id` values now range from 1 to 35.
- No clear duplicate job IDs were found.
- No clear duplicate job links were found.
- The same 12-column structure was kept.
- The cleaned dataset was not updated yet.

The raw dataset will be cleaned later by updating or regenerating:
- `city_cleaned`
- `experience_category`
- `role_category`
...
Started Kaggle Intro to Machine Learning.

Main concepts introduced:

### Machine Learning Model

A machine learning model learns patterns from data and uses those patterns to make predictions.

### Features

Features are the input columns used by the model to make predictions.
...
A prediction is the output generated by the model after learning from data.

## Day 15 Main Takeaway

Today’s work focused on expanding the dataset while keeping data quality in mind.

The dataset expansion is important because a larger sample can make the analysis more reliable and help check whether the early findings still hold.

So far, the most repeated themes across the new postings continue to include:
...
- data cleaning
- data validation
- AI and machine learning-related tasks

## Day 15 Next Steps

- Continue expanding the dataset with more Saudi data-related postings.
- Collect 10 additional postings.
- Update the raw dataset again.
- Clean the expanded dataset after adding more postings.
- Re-create the cleaned analysis-ready columns.
- Re-run the analysis after the dataset expansion.
